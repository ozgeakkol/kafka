...
public class ConsumerDemo {
    public static void main(String[] args) {
        ...
        properties.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG,
                               "earliest"); // earliest --> read from the beginning of the topic //latest --> read only new messages //none --> error
        ...
        /*
         if you have more than one topic you can write this code:
